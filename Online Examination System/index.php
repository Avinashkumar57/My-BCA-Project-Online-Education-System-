   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="flex">
            ...
            <a href="#"><i class="fas fa-a fa-spin fa-pulse"></i><span>English</span></a>
             <a href="#"><i class="fas fa-baseball-ball fa-spin fa-pulse"></i><span>Sports</span>
</a>
      ...
      <div class="box">
         ...
         <div class="flex">
            ...
            <a href="#"><i class="fab fa-python"></i><span>bootstrap</span></a>
         </div>
      </div>

      <div class="box Teacher">
         <h3 class="title">Become a Teacher</h3>
         <p><h2><li>Select a topic of your interest and design a curriculum prior to recording your videos.</li> 
