   ...
   <div class="row">
      ...
      <div class="col">
         ...
         <div class="thumb">
            ...
            <img src="uploaded_files/<?= $fetch_playlist['thumb']; ?>" alt="" height="150" width="150">
         </div>
      </div>

      <div class="col">
         <div class="teacher">
            <img src="uploaded_files/<?= $fetch_teacher['image']; ?>" alt="" height ="90" weight="100">
            <div>
...
<section class="videos-container">
   ...
   <div class="box-container">
      ...
      <a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>" class="box">
         ...
         <img src="uploaded_files/<?= $fetch_content['thumb']; ?>" alt="" hight="150" width="150">
