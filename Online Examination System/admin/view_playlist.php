...
<section class="playlist-details">
   ...
   <?php
      $select_playlist = $conn->prepare("SELECT * FROM `playlist` WHERE id = ? AND teacher_id = ?");
...
<section class="contents">
   ...
   <?php
      $select_videos = $conn->prepare("SELECT * FROM `content` WHERE teacher_id = ? AND playlist_id = ?");
