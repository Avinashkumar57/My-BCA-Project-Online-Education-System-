...
if(isset($_POST['submit'])){
   ...
   if($select_teacher->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_teacher = $conn->prepare("INSERT INTO `teachers`(id, name, profession, email, number, password, image) VALUES(?,?,?,?,?,?,?)");
         $insert_teacher->execute([$id, $name, $profession, $email, $number, $cpass, $rename]);
