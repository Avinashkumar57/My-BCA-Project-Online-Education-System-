...
if(isset($_POST['delete_playlist'])){
   ...
   $verify_playlist = $conn->prepare("SELECT * FROM `playlist` WHERE id = ? AND teacher_id = ? LIMIT 1");
...
<section class="contents">
   ...
   <?php
      ...
      $search = $_POST['search'];
      $select_videos = $conn->prepare("SELECT * FROM `content` WHERE title LIKE '%{$search}%' AND teacher_id = ? ORDER BY date DESC");
...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      if(isset($_POST['search']) or isset($_POST['search_btn'])){
         $search = $_POST['search'];
         $select_playlist = $conn->prepare("SELECT * FROM `playlist` WHERE title LIKE '%{$search}%' AND teacher_id = ? ORDER BY date DESC");
