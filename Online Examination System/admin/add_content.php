...
if(isset($_POST['submit'])){
   ...
   if($thumb_size > 2000000){
      ...
      $add_playlist = $conn->prepare("INSERT INTO `content`(id, teacher_id, playlist_id, title, description, video, thumb, status) VALUES(?,?,?,?,?,?,?,?)");
...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>select document/audio <span></span></p>
      <input type="file" name="doc/audio" accept=""class="box">
